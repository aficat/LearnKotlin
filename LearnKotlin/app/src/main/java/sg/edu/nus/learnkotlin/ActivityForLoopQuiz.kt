...
import kotlinx.android.synthetic.main.activity_for_loop_quiz.*

class ActivityForLoopQuiz : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_for_loop_quiz)
        ...
        val opt1 = SpannableStringBuilder("2 4 6 8 10")
        opta.text = opt1

        val optb = findViewById<TextView>(R.id.option6)
        val opt2 = SpannableStringBuilder("4 6 8 10")
        optb.text = opt2

        val optc = findViewById<TextView>(R.id.option7)
        val opt3 = SpannableStringBuilder("0 2 4 6 8 10")
        optc.text = opt3

        val optd = findViewById<TextView>(R.id.option8)
        val opt4 = SpannableStringBuilder("0 2 4 6 8")
        optd.text = opt4
        ...
        forloop_submit2.setOnClickListener {

...
import kotlinx.android.synthetic.main.activity_array_quiz.*

class ActivityArrayQuiz : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val question = SpannableStringBuilder("What is an array?")
        question1.text = question.toString()

        val optiona = findViewById<TextView>(R.id.option1)
        val option1 = SpannableStringBuilder("A value of the same type.")
        optiona.text = option1

        val optionb = findViewById<TextView>(R.id.option2)
        val option2 = SpannableStringBuilder("A collection of values of different types.")
        optionb.text = option2

        val optionc = findViewById<TextView>(R.id.option3)
        val option3 = SpannableStringBuilder("A collection of values of the same type.")
        optionc.text = option3

        val optiond = findViewById<TextView>(R.id.option4)
        val option4 = SpannableStringBuilder("A collection of values.")
        ...
        val opt1 = SpannableStringBuilder("1 3")
        opta.text = opt1

        val optb = findViewById<TextView>(R.id.option6)
        val opt2 = SpannableStringBuilder("1 2")
        optb.text = opt2

        val optc = findViewById<TextView>(R.id.option7)
        val opt3 = SpannableStringBuilder("1 2 3")
        optc.text = opt3

        val optd = findViewById<TextView>(R.id.option8)
        val opt4 = SpannableStringBuilder("2 3")
        optd.text = opt4
        ...
        array_submit1.setOnClickListener {
            ...
            if (id != -1) { // If radio button is selected
                ...
                if (radio.text == option3) { //CORRECT ANSWER
                    ...
                    // Get radio group selected status and text using button click event
                    array_submit2.setOnClickListener {
                        // Get the checked radio button id from radio group
